...
<body>
	...
	String query = "select sum(price) as 'Total sum of the price'"
			+" from orders,shopping_cart,product where r_purchase_num=purchase_num and s_product_num=product_num and customer_num=cus_num";
